...
function resetConfirmation() {
  const resetMessage = document.querySelector(".js-reset-confirmation");

  const resetMessageHtml = `
  <div>Are you sure you want to reset the score?</div>
  <button class="reset-confirm-button js-reset-yes">Yes</button>
  <button class="reset-confirm-button js-reset-no">No</button>
  `;

  resetMessage.innerHTML = resetMessageHtml;
